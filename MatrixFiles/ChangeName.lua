...
if result.id_ then 
local abbs = DevAbs:get("MatrixdevTEAM:Name"..result.id_)
if not result.first_name_ then 
if abbs then 
DevAbs:del("MatrixdevTEAM:Name"..result.id_) 
end
end
...
DevAbs:set("MatrixdevTEAM:Name"..result.id_, result.first_name_)  
end
end
end,nil) 
end
