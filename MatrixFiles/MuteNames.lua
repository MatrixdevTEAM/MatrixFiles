...
if DevAbs:get(Matrix.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Matrix.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Matrix.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Matrix.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Matrix.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Matrix.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
MatrixName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if MatrixName then 
MatrixNames = DevAbs:smembers(Matrix.."Abs:Mute:Names"..msg.chat_id_) or ""
if MatrixNames and MatrixNames[1] then 
for i=1,#MatrixNames do 
if MatrixName:match("(.*)("..MatrixNames[i]..")(.*)") then 
...
DevAbs:set(Matrix.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Matrix.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
